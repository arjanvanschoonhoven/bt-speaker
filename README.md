...
```bash
sudo -i
bash <(curl -s https://raw.githubusercontent.com/arjanvanschoonhoven/bt-speaker/master/install.sh)
```

For details refer to the comments in the [install script](https://github.com/arjanvanschoonhoven/bt-speaker/blob/master/install.sh).
